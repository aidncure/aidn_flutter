...
class _MedicineOrderDetailState extends State<MedicineOrderDetail> {
                ...
                Container(
                  ...
                  child: Padding(
                    ...
                    child: Text(
                      getTranslated(context, medicineOrderDetail_orderSummary).toString(),
                      style: TextStyle(
                          fontSize: 22, color:  Palette.dark_blue, fontWeight: FontWeight.bold),
                    ),
                  ),
                ),
                Padding(
                    ...
                    children: [
                      Container(
                        ...
                        child: Text(
                          widget.pharmacyName!,
                          style: TextStyle(
                              fontSize: 20, color:  Palette.blue, fontWeight: FontWeight.bold),
                        ),
                      ),
                      Padding(
                  ...
                  children: [
                    Container(
                      ...
                      child: Text(
                        ...
                        style: TextStyle(
                            fontSize: 20, color:  Palette.dark_blue, fontWeight: FontWeight.bold),
                      ),
                    ),
                    Padding(
                      padding: const EdgeInsets.symmetric(horizontal: 0, vertical: 5),
                    ...
                    ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        medicineAmountTotal =
                            bookMedicineList![index].qty! * bookMedicineList![index].price!;
                        return Column(
                          children: [
                            Padding(
  ...
  Future<BaseModel<MedicineOrderDetails>> callApiMedicineOrderDetail() async {
    ...
    try {
      response = await RestClient(Retro_Api().Dio_Data()).medicineOrderDetailRequest(widget.orderId);
      setState(() {
        _loadding = false;
