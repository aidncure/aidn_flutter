...
class _MedicineOrderState extends State<MedicineOrder> {
        ...
        child: medicineList.length != 0
                  ...
                  ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      if (medicineList[index].deliveryCharge != null) {
                        grandTotal =
                            medicineList[index].amount! + medicineList[index].deliveryCharge!;
                      } else {
                                        ...
                                        children: [
                                          Row(
                                            ...
                                            children: [
                                              Container(
                                                child: Text(
                                                  getTranslated(context, medicineOrder_bookingId)
                                                      .toString(),
                                                  style: TextStyle(
                                      ...
                                      child: Column(
                                        children: [
                                          Container(
                                            alignment: AlignmentDirectional.topStart,
                                            child: Text(
                                              getTranslated(context, medicineOrder_items)
                                                  .toString(),
                                              style: TextStyle(
                                                fontSize: width * 0.04,
                                                color: Palette.blue,
                                        ...
                                        children: [
                                            ...
                                            child: Column(
                                              children: [
                                                Container(
                                                  alignment: AlignmentDirectional.topStart,
                                                  child: Text(
                                                    getTranslated(context, medicineOrder_orderedOn)
                                                        .toString(),
                                                    style: TextStyle(
                                                      fontSize: width * 0.04,
                                                      color: Palette.blue,
                                          ...
                                          Container(
                                            child: ElevatedButton(
                                              child: Text(
                                                getTranslated(context, medicineOrder_viewMore)
                                                    .toString(),
                                                style: TextStyle(
                                                  fontSize: 16,
                                                  color: Palette.white,
                                                ...
                                                Navigator.push(
                                                  ...
                                                  MaterialPageRoute(
                                                    builder: (context) => MedicineOrderDetail(
                                                      pharmacyName:
                                                          medicineList[index].pharmacyDetails!.name,
                                                      pharmacyAddress: medicineList[index]
                                                          .pharmacyDetails!
                                                          .address,
            ...
            : Container(
                ...
                child: Text(
                  ...
                  style: TextStyle(
                      fontSize: width * 0.04, color: Palette.grey, fontWeight: FontWeight.bold),
                ),
              ),
      ),
    );
  ...
  Future<BaseModel<MedicineOrderModel>> callApiMedicineOrder() async {
    ...
    try {
      response = await RestClient(Retro_Api().Dio_Data()).medicineOrderRequest();
      setState(() {
        _loadding = false;
