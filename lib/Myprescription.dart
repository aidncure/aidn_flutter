...
class Myprescription extends StatefulWidget {
  String? doctorImage;
  String? doctorName;
  String? doctorTreatmentName;
  String? doctorAddress;
  String? appointmentTime;
  String? appointmentDate;
  String? patientName;
  int? appointmentIdPrescription;
  int? appointmentId;
  int? userRating;
...
class _MyprescriptionState extends State<Myprescription> {
  ...
  Future<BaseModel<prescription>> callApiPrescription() async {
    prescription response;
    setState(() {
      _loadding = true;
    });
    try {
      response = await RestClient(Retro_Api().Dio_Data()).prescriptionRequest(widget.appointmentIdPrescription);
