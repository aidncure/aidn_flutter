...
class _AllPharamacyState extends State<AllPharamacy> {
      ...
      body: ModalProgressHUD(
        ...
        child: GestureDetector(
          ...
          child: _searchResult.length > 0 || _search.text.isNotEmpty
              ? _searchResult.length != null && _searchResult.length != 0
                  ? ListView.builder(
                                            ...
                                            child: GestureDetector(
                                              onTap: () {
                                                Navigator.push(
                                                  ...
                                                  MaterialPageRoute(
                                                    builder: (context) =>
                                                        PharamacyDetail(_searchResult[index].id),
                                                  ),
                                                );
                                              },
                                              child: Container(
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      child: Card(
                                        child: CachedNetworkImage(
                                          alignment: Alignment.center,
                                          imageUrl: pharamacies[index].fullImage!,
                                          fit: BoxFit.fill,
                                          placeholder: (context, url) =>
                                            ...
                                            child: GestureDetector(
                                              onTap: () {
                                                Navigator.push(
                                                  ...
                                                  MaterialPageRoute(
                                                    builder: (context) =>
                                                        PharamacyDetail(pharamacies[index].id),
                                                  ),
                                                );
                                              },
                                              child: Container(
  ...
  Future<BaseModel<pharamacy>> CallApiPharamacies() async {
    pharamacy response;
    ...
    try {
      response = await RestClient(Retro_Api2().Dio_Data2()).pharamaciesRequest();
      setState(() {
        if (response.success == true) {
          _loadding = false;
          pharamacies.addAll(response.data!);
  ...
  onSearchTextChanged(String text) async {
    ...
    pharamacies.forEach((appointmentData) {
