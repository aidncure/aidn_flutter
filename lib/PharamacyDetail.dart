...
class PharamacyDetail extends StatefulWidget {
  ...
  PharamacyDetail(int? id) {
    this.id = id;
  }

  @override
  _PharamacyDetailState createState() => _PharamacyDetailState(id);
}
...
class _PharamacyDetailState extends State<PharamacyDetail> with TickerProviderStateMixin {
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: new DecorationImage(
                            ...
                            colorFilter: new ColorFilter.mode(
                                Palette.black.withOpacity(0.7), BlendMode.dstATop),
                ...
                Container(
                  ...
                  child: TabBarView(
                    ...
                    children: [
                      ...
                      //tab 2
                      medicines.length != 0 && medicines.length != "null"
                          ? Container(
                              child: GridView.builder(
                                ...
                                gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                                    crossAxisCount: 2, mainAxisSpacing: 3, childAspectRatio: 2.5),
  ...
  Future<BaseModel<PharamaciesDetails>> CallApipharamacyDetail() async {
    ...
    try {
      response = await RestClient(Retro_Api2().Dio_Data2()).pharmaciesdetailRequest(id);
      setState(() {
