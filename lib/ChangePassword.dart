...
class _ChangePasswordState extends State<ChangePassword> {
              ...
              child: Container(
                ...
                child: Column(
                  children: [
                        ...
                        child: Container(
                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              ...
                              hintText: getTranslated(context, changePassword_oldPassword_hint)
                                  .toString(),
                            ...
                            validator: (String? value) {
                              if (value!.isEmpty) {
                                return getTranslated(context, changePassword_oldPassword_validator)
                                    .toString();
                              }
                              return null;
                            },
                      ...
                      child: Container(
                        ...
                        child: Container(
                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              border: InputBorder.none,
                              hintText: getTranslated(context, changePassword_newPassword_hint)
                                  .toString(),
                              hintStyle: TextStyle(fontSize: width * 0.035, color: Palette.grey),
                              suffixIcon: IconButton(
                                icon: Icon(
                            ...
                            validator: (String? value) {
                              if (value!.isEmpty) {
                                return getTranslated(context, changePassword_newPassword_validator1)
                                    .toString();
                              } else if (value.length < 6) {
                                return getTranslated(context, changePassword_newPassword_validator2)
                                    .toString();
                              }
                              return null;
                            },
                      ...
                      child: Container(
                        ...
                        child: Container(
                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              border: InputBorder.none,
                              hintText: getTranslated(context, changePassword_confirmPassword_hint)
                                  .toString(),
                              hintStyle: TextStyle(fontSize: width * 0.035, color: Palette.grey),
                              suffixIcon: IconButton(
                                icon: Icon(
                            ...
                            validator: (String? value) {
                              if (value!.isEmpty) {
                                return getTranslated(
                                        context, changePassword_confirmPassword_validator1)
                                    .toString();
                    ...
                    Container(
                      margin: EdgeInsets.only(
                          left: width * 0.08, right: width * 0.08, top: height * 0.06),
                      width: width * 1.0,
                      height: height * 0.06,
  ...
  Future<BaseModel<ChangePasswords>> changepassword() async {
    ...
    try {
      response = await RestClient(Retro_Api().Dio_Data()).changePasswordRequest(body);
